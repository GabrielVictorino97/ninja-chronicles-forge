...
export const mockItems: Item[] = [
  {
    ...
    type: "tool",
    rarity: "common",
    description: "Arma básica de arremesso.",
    price: 25,
    icon: "Sword",
  },
  {
    ...
    type: "tool",
    rarity: "common",
    description: "Estrela ninja afiada.",
    price: 30,
    icon: "Star",
  },
  {
    ...
    type: "tool",
    rarity: "uncommon",
    description: "Agulhas precisas para pontos vitais.",
    price: 70,
    icon: "Pin",
  },
  {
    ...
    type: "tool",
    rarity: "uncommon",
    description: "Pergaminho explosivo.",
    price: 120,
    icon: "Bomb",
  },
  {
    ...
    type: "weapon",
    rarity: "rare",
    description: "Espada longa e mortal.",
    price: 800,
    icon: "Swords",
  },
  {
    ...
    type: "tool",
    rarity: "uncommon",
    description: "Pergaminho selado para invocar técnicas.",
    price: 200,
    icon: "ScrollText",
  },
  {
    ...
    type: "armor",
    rarity: "rare",
    description: "Colete tático verde.",
    price: 1200,
    icon: "Shirt",
  },
  {
    ...
    type: "accessory",
    rarity: "common",
    description: "Bandana com símbolo da vila.",
    price: 100,
    icon: "Crown",
  },
  {
  ...
  },
  {
    ...
    type: "consumable",
    rarity: "uncommon",
    description: "Cura efeitos de veneno.",
    price: 110,
    icon: "FlaskConical",
  },
];
