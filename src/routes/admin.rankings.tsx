...
import { adminRankingService, adminVillageService, adminBloodlineClanService } from "@/services/admin";
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={
          <>
            <Button variant="outline" onClick={() => { refetch(); toast.success("Ranking atualizado"); }}>
      ...
      <div className="flex flex-col md:flex-row gap-2">
        ...
        <Select value={clan} onValueChange={setClan}>
          ...
          <SelectContent>
            ...
            {clans.map((c) => <SelectItem key={c.id} value={c.id}>{c.name}</SelectItem>)}
          </SelectContent>
        </Select>
      </div>
