    ...
    return (
      <div className="space-y-5">
        <SectionTitle
          ...
          description="Junte-se a um clã ou crie o seu."
        />
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Card className="shadow-card">
            <CardHeader>
              <CardTitle>Buscar clãs</CardTitle>
            </CardHeader>
            <CardContent className="space-y-2">
              ...
              />
              {["Folha Negra", "Punho de Ferro", "Dragões da Areia"]
                ...
                .map((c) => (
                  ...
                  >
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      onClick={() => toast.info("Solicitação enviada")}
                    >
                      Solicitar
                    </Button>
                  </div>
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Card className="shadow-card">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-base">
              <Trophy className="size-4 text-primary" /> Membros
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-1.5">
            {clan.members.map((m) => (
              ...
              >
                ...
                <span className="text-xs font-semibold text-ryous tabular-nums">
        ...
        <Card className="shadow-card">
          <CardHeader>
            <CardTitle className="text-base">Mural</CardTitle>
          </CardHeader>
          <CardContent className="space-y-2">
            {clan.wall.length === 0 ? (
