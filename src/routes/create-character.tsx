...
function CreateCharacterPage() {
  ...
  const [attrs, setAttrs] = useState<BaseAttributes>({
    taijutsu: STARTING_BASE,
    ninjutsu: STARTING_BASE,
    genjutsu: STARTING_BASE,
    intelligence: STARTING_BASE,
    vitality: STARTING_BASE,
    chakra: STARTING_BASE,
    agility: STARTING_BASE,
    luck: STARTING_BASE,
  });
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {!villages ? (
                ...
                villages.map((v) => (
                  ...
                  >
                    <div className="grid size-10 shrink-0 place-items-center rounded-lg bg-background text-xl">
                      {v.symbol}
                    </div>
                    <div>
          ...
          {step === 4 && (
            <div>
              ...
              <p className="mb-3 text-xs text-muted-foreground">
                Você começa sem elemento — aprenda o seu primeiro a partir do nível 20 na tela de
                personagem.
              </p>
              <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <Button
                        size="icon"
                        variant="outline"
                        disabled={attrs[k] <= STARTING_BASE}
                        onClick={() => setAttrs({ ...attrs, [k]: attrs[k] - 1 })}
                      >
                        −
                      </Button>
